            ...
            <form method="post" action="/store" enctype="multipart/form-data">
               ...
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="mobile" class="form-control" placeholder="Your Phone Number *" value="{{old('mobile')}}" />
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-danger btnContact" type="submit">Add</button>

                        </div>
                        <div class="form-group">
                            {{-- <input type="submit" name="save" class="btnContact" value="Send Message" /> --}}
                            <a href="/view_user">View User</a><br>
